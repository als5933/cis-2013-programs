...
var passwordCheckOld = function () 
{
    ...
    //this gets input (a password) from the user 
...
//I'm using this for loop to filter through the bad password array by incrementing i
   {
     if(stringPassword === arrayBadPasswords[i])
     //if the password entered by the user is exactly the same as one of the elements in arrayBadPasswords, the user will be prompted to enter a different password 
      {
         stringOutput= "Error. This password is not an acceptable password. Please try again.";
         $("password").value= "";
         //this clears out the password box
      }
        else {
         //if the password entered is not a bad password, I am now validating that the password entered in not less than 8 characters
 ...
 if (stringOutput!= "I'm sorry. Your password is too short. Please enter a new one." && stringOutput!="Error. This password is not an acceptable password. Please try again.")
 //as long as the password entered is not a bad password and is >=8 characters, the password is good and the user is alerted 
   {
 ...
 //this puts the output back into the DOM 
