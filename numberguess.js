...
intMax = parseInt(prompt("Choose the highest number (at least 2 more than your Lowest number) in your guessing range: "));

while (isNaN(intMax) || (intMax <= (intMin +2)))
       {
        intMax=parseInt(prompt("I'm sorry but your highest number choice is invalid. \n" + "Please choose the highest number (at least 2 more than your Lowest number) in your guessing range: "));
       }
 ...
 while(intGuess != intRandom)
{
    ...
    {
        alert("I'm sorry. Your guess is too low.");
        intGuess = parseInt(prompt("Enter your guess: "));
    }
    else {
        alert ("I'm sorry. Your guess is too high.");
        intGuess = parseInt(prompt("Enter your guess: "));
    }
    intCount++;
}
