...
//calculate the circle area and circumference using convenient Math Object methods	
	...
	"\n\n" + "The Triangle area is " + 	triArea(floatTriSide1, floatTriSide2, floatTriSide3, floatS) + 
...
var calcTriangleArea = function ()
{
    ...
    alert ("The Triangle area is " + triArea(floatTriSide1, floatTriSide2, floatTriSide3, floatS));
}
...
//    $("radius").value = "";
    ...
    $("calc_rect_area").onclick = calcRectArea; //runs that calcRectArea function when clicked
    $("calc_rect_perim").onclick = calcRectPerim;// runs that calcRectPerim function when clicked
